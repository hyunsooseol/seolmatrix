...
multilevelClass <- if (requireNamespace('jmvcore')) R6::R6Class(
    ...
    private = list(
        ...
        .init = function() {
            ...
            <p>1. The rationale of Multilevel Correlation is described in the <a href='https://cran.r-project.org/web/packages/correlation/vignettes/multilevel.html' target = '_blank'>page.</a></p>
